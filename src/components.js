class AICard extends HTMLElement {
    connectedCallback() {
        ...
        flex flex-col justify-center items-center text-center max-w-[500px] h-auto py-10 gap-6 px-10
        xl:flex-row xl:items-center xl:text-left xl:h-[175px] xl:py-0 xl:gap-0 xl:px-12 xl:max-w-full">
            ...
            <!-- Button -->
            <a href="${gitLink}" target="_blank" class="group inline-flex items-center 
